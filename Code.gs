...
function setupFaqSheet(sheet) {
  const data = [
    ...
    [''],
    ['Q13: 休憩時間を記録したいです'],
    ['A13: 現在は休憩時間の自動計算機能はありません。'],
    ['   - スプレッドシートで「休憩時間」列を直接編集してください'],
    ['   - 例: 1時間の休憩の場合は「1:00」と入力'],
    [''],
