...
graph LR
    %% 第1層: フェーズ0
    P0[フェーズ0<br/>配布用スプレッドシート<br/>セットアップ<br/>✅ ほぼ完了]
    
    %% 第2層: フェーズ1（AとBは並列実行可能）
    P1A[フェーズ1-A<br/>労働時間表示機能<br/>⚪ 未着手]
    P1B[フェーズ1-B<br/>スプレッドシート<br/>リンク機能<br/>⚪ 未着手]
...
graph TD
    subgraph "フェーズ1-A: 労働時間表示機能"
        A_BE[バックエンド<br/>⚪ 未着手] --> A_FE[フロントエンド<br/>⚪ 未着手]
    end
    
    subgraph "フェーズ1-B: スプレッドシートリンク機能"
        B_BE[バックエンド<br/>⚪ 未着手] --> B_FE[フロントエンド<br/>⚪ 未着手]
    end
    
    classDef notStarted fill:#E0E0E0,stroke:#9E9E9E,stroke-width:2px,color:#000
    class A_BE,A_FE,B_BE,B_FE notStarted
```
